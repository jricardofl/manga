...
w6 <- as.Date("2022-02-04")
last <- as.Date("2022-02-11")
today <- as.Date("2022-02-18")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,40, variando entre R\$1,70 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,57. Em 2020, o preço deflacionado é de R\$1,77 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 3,07). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com pouca oferta. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -1,41\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,83, variando entre R\$2,10 e R\$1,40. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,62, menor do que o preço deflacionado de 2020 (R\$2,02), e também menor do que o preço de 2021 (R\$3,09). Em relação à semana anterior, contudo, os preços tiveram um aumento de R\$3,98%
