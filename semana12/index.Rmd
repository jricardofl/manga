...
w10 <- as.Date("2022-03-11")
last <- as.Date("2022-03-18")
today <- as.Date("2022-03-25")
sem_ano <- 12 #ajustar semanalmente
```
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,44, variando entre R\$1,70 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,56. Em 2020, o preço deflacionado é de R\$1,68 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 3,77). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com oferta limitada no Vale. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 1,41\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,17, variando entre R\$1,40 e R\$1,00. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,88, menor do que o preço deflacionado de 2020 (R\$1,25), e também menor do que o preço de 2021 (R\$1,92). Em relação à semana anterior os preços tiveram uma nova queda bastante expressiva, de -26,88%.

Nos dados de exportação, os preços de manga Palmer aumentaram em relação à semana anterior, chegando a R\$1,97 (7,65%), variando entre R\$2,20 e R\$1,70. A safra peruana praticamente está encerrada e isto abre oportunidade para os produtores brasileiros. 
